...
bake(file = "output/round_01/ovov_01_el.rds",{
  el <- measlespkg::eval_logLik(mifs_global_01, ncores=ncores, np_pf = NP_MIF, nreps=ncores)
  el
})
@
...
bake(file = "output/round_02/ovov_02_el.rds",{
  el <- measlespkg::eval_logLik(mifs_global_02, ncores = ncores, np_pf = NP_MIF, nreps=ncores)
  el
})
@
...
bake(file = "output/round_03/ovov_03_el.rds",{
  el <- measlespkg::eval_logLik(mifs_global_03, ncores = ncores, np_pf = NP_MIF, nreps=ncores)
  el
})
@
...
\begin{table}[htbp]
  ...
  \begin{threeparttable}
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}p{2cm} *{3}{>{\centering\arraybackslash}p{1.5cm}} >{\centering\arraybackslash}p{2.5cm}}
      ...
      \multicolumn{1}{l}{\(I_{20}\)} & \multicolumn{3}{c}{$871$}       & $$\Sexpr{est_mle_vec["sigma_xi[unit1]"]}$$\\
      \multicolumn{1}{l}{\(R_{20}\)} & \multicolumn{3}{c}{$302852$}    & $$\Sexpr{est_mle_vec["sigma_xi[unit1]"]}$$\\
      \multicolumn{1}{l}{\(S_{30}\)} & \multicolumn{3}{c}{$19573727$}  & $$\Sexpr{est_mle_vec["sigma_xi[unit1]"]}$$\\
      \multicolumn{1}{l}{\(I_{30}\)} & \multicolumn{3}{c}{$2550$}      & $$\Sexpr{est_mle_vec["sigma_xi[unit1]"]}$$\\
      \multicolumn{1}{l}{\(R_{30}\)} & \multicolumn{3}{c}{$131092$}    & $$\Sexpr{est_mle_vec["sigma_xi[unit1]"]}$$\\
      \midrule
      \addlinespace
