...
\begin{tabular}{lllr} 
  ...
  5. & PF & Changing initial values &
     \Sexpr{myround(2*((length(params_wwr) - length(params_fixed)) - est_mle_vec_sbh["logLik"]),tab_signif)}
  \\
