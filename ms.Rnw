...
RUN_LEVEL = 1
NP_MIF       = switch(RUN_LEVEL, 100,   5000,  50000)
...
\begin{center}    
    \begin{tabular}{lccc}  % Left-aligned for the first column, centered for the other two columns
      ...
      \(S_{10}\)     & 3876549   & $\Sexpr{round(pop*est_mle_vec["S10"],0)}$  & $\Sexpr{round(pop*est_mle_vec_sbh["S10"],0)}$\\
      \(I_{10}\)     & 30351     & $\Sexpr{round(pop*est_mle_vec["I10"],0)}$  & $\Sexpr{round(pop*est_mle_vec_sbh["I10"],0)}$\\
      \(R_{10}\)     & 1315221   & $\Sexpr{round(pop*est_mle_vec["R10"],0)}$  & $\Sexpr{round(pop*est_mle_vec_sbh["R10"],0)}$\\
      \(S_{20}\)     & 57139612  & $\Sexpr{round(pop*est_mle_vec["S20"],0)}$  & $\Sexpr{round(pop*est_mle_vec_sbh["S20"],0)}$\\
      \(I_{20}\)     & 871       & $\Sexpr{round(pop*est_mle_vec["I20"],0)}$  & $\Sexpr{round(pop*est_mle_vec_sbh["I20"],0)}$\\
      \(R_{20}\)     & 302852    & $\Sexpr{round(pop*est_mle_vec["R20"],0)}$  & $\Sexpr{round(pop*est_mle_vec_sbh["R20"],0)}$\\
      \(S_{30}\)     & 19573727  & $\Sexpr{round(pop*est_mle_vec["S30"],0)}$  & $\Sexpr{round(pop*est_mle_vec_sbh["S30"],0)}$\\
      \(I_{30}\)     & 2550      & $\Sexpr{round(pop*est_mle_vec["I30"],0)}$  & $\Sexpr{round(pop*est_mle_vec_sbh["I30"],0)}$\\
      \(R_{30}\)     & 131092    & $\Sexpr{round(pop*est_mle_vec["R30"],0)}$  & $\Sexpr{round(pop*est_mle_vec_sbh["R30"],0)}$\\
      \midrule
