...
\yize{ADD ANOTHER ROUND OF MIF WITH SBH INITIALIZATION \\ PLOT THE COND LIK AT NEW EST \\ MAXIMIZE/ FILTER WITH PAL ON THEIR MLE. I DOUBT THEIR RESULTS CAN BE EXACTLY REPRODUCED.}
